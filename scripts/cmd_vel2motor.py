...
def listener():
    ...
    global left_back, left_front, right_back, right_front 
    left_back = rospy.Publisher('/left_back_motor/command', Float32, queue_size=10)
    left_front = rospy.Publisher('/left_front_motor/command', Float32, queue_size=10)
    right_back = rospy.Publisher('/right_back_motor/command', Float32, queue_size=10)
    right_front = rospy.Publisher('/right_front_motor/command', Float32, queue_size=10)
